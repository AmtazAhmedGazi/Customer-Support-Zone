...
const Footer = () => {
  return (
    <div className=" bg-black text-white">
      <div className="max-w-[1440px] mx-auto grid grid-cols-2 md:grid-cols-5 py-10 md:py-20 gap-10 md:gap-27 pl-5 md:pl-0">
      ...
      <h4 className="max-w-[1440px] mx-auto py-5 md:py-12.5 text-center text-md text-[#FAFAFA] font-light border-t border-[#444444]">
